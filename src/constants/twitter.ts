...
export const KEY_SYNCED_TWITTER_BOOKMARKS_ID_LIST =
  'key_synced_twitter_bookmarks_id_list';

export const MESSAGE_COLLECT_TWEETS_BOOKMARKS =
  'message/collect_tweets_bookmarks';
export const MESSAGE_SYNC_TO_PKM = 'message/sync_to_pkm';
export const MESSAGE_GET_PHASE_SPECIFIC_RAW_DATA =
  'message/get_phase_specific_raw_data';
